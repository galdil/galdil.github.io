...
<script>
  document.getElementById("subbut").addEventListener("click", function(e) {
	...
	const interactionTokenInput = document.getElementBy('interactionToken');
	...
	const stripToken = stripTokenInput.value.trim();
  	...
  	if(mediaId) {
  	  document.body.innerHTML += `<div style="margin-top: 30pxclass="apester-media" data-media-id=${mediaId}height="512"></div>`;
  	}
  	if (interactionToken) {
